...
public class FixedSeparatorMessageTokenizer implements StringMessageTokenizer {
    ...
    /**
     * @param separator delimiter at the end of messages.
     * @param charset - charset of incoming bytes - good default is UTF-8
     */
     ...
     *
     * @param msg string to be encoded - with no delimiter.
     * @return a ByteBuffer with the message content converted to bytes,
     *         after framing information has been added.
     * @throws CharacterCodingException when sequence of bytes received is not legal according to charset.
     */
