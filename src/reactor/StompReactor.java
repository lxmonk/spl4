...
import protocol.stomp.StompProtocolFactory;
...
public class StompReactor {
	private static final Logger logger = Logger
			.getLogger("edu.spl.reactor.stomp");
	...
	/**
	 * Main program: StompReactor Reactor-based server for the Stomp protocol.
	 * Listening port number and number of threads in the thread pool are read
	 * from the commandline.
	 * 
	 * @param args
	 *            command line arguments: port poolSize
	 */
	public static void main(String args[]) {
		...
		try {
			...
			thread.start();
			logger.info("StompReactor is ready on port "
					+ sr.reactor().getPort());
